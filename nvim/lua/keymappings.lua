...
m.nnoremap('<leader>b', function() require('plugins.config.telescope').buffers() end, 'silent', 'Telescope Buffers')
m.nnoremap('<leader>c', function() require('plugins.config.telescope').commits() end, 'silent', 'Telescope Commits')
...
m.nnoremap('<leader>gf', function() require('plugins.config.telescope').git_files() end, 'silent', 'Telescope Git Files')
m.nnoremap('<leader>l', ':NvimTreeToggle<cr>', 'silent', 'NvimTree Toggle')
m.nnoremap('<leader>m', ':Git<cr>', 'silent', 'Fugitive')
m.nnoremap('<leader>p', function() require('plugins.config.telescope').find_files() end, 'silent', 'Telescope Files')
m.nnoremap('<leader>q', function() require('plugins.config.telescope').quickfix() end, 'silent', 'Telescope Quickfix')
m.nnoremap('<leader>r', function() require('plugins.config.telescope').live_grep() end, 'silent', 'Telescope Grep')
m.nnoremap('<leader>v', function() require('plugins.config.telescope').find_config_files() end, 'silent', 'Telescope Config Files')
m.nnoremap('<leader>z', function() require('plugins.config.telescope').colorscheme() end, 'silent', 'Telescope Colorschemes')
