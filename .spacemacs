...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Space Mono Nerd Font Complete Mono"
                               :size 14
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
